...
public class CreateDatabaseObjectsServlet
  extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    dbQueries.createObjects();
    carLogger.Logger("Created objects ..");
    response.sendRedirect("listcarsjdbc");
    ...
    //            out.println("<link type=\"text/css\" rel=\"stylesheet\" href=\"jdeveloper.css\"/>");
    ...
    //                out.println("<form name=\"createdatabaseobjects\" action=\"createdatabaseobjects\" method=\"post\">\n" +
    ...
    //            out.println("For SQLServer, ensure that the SQL Server Browser service is running and the correct port (typically 1433) is open.</code><br/><br/>");
